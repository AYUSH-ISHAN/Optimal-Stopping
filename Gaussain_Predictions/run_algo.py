...
# from utilities import configs_getter
import payoff
import LSM
import stock_model
# from run import write_figures
...
def _run_algos():
  ...
  tmp_dirpath = f'{fpath}.tmp_results'   ###  above both locations helps in  storing the output in draft format
  os.makedirs(tmp_dirpath, exist_ok=True)
  atexit.register(shutil.rmtree, tmp_dirpath)  # registers  function to be executed at the termination
  tmp_files_idx = 0
